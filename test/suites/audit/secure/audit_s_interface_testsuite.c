...
/* List of tests */
static void tfm_audit_test_2001(struct test_result_t *ret);

static struct test_t audit_veneers_tests[] = {
    {&tfm_audit_test_2001, "TFM_AUDIT_TEST_2001",
...
void register_testsuite_s_audit_interface(struct test_suite_t *p_test_suite)
{
    ...
    set_testsuite("Audit Logging secure interface test (TFM_AUDIT_TEST_2XXX)",
