...
void register_testsuite_ns_crypto_interface(struct test_suite_t *p_test_suite)
{
    ...
    set_testsuite("Crypto non-secure interface test (TFM_CRYPTO_TEST_1XXX)",
