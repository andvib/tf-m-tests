...
/* List of tests */
static void tfm_s_crypto_test_1001(struct test_result_t *ret);
#ifdef TFM_CRYPTO_TEST_ALG_CBC
static void tfm_s_crypto_test_1002(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_ALG_CBC */
#ifdef TFM_CRYPTO_TEST_ALG_CFB
static void tfm_s_crypto_test_1003(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_ALG_CFB */
#ifdef TFM_CRYPTO_TEST_ALG_CTR
static void tfm_s_crypto_test_1005(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_ALG_CTR */
static void tfm_s_crypto_test_1007(struct test_result_t *ret);
static void tfm_s_crypto_test_1008(struct test_result_t *ret);
#ifdef TFM_CRYPTO_TEST_ALG_CFB
static void tfm_s_crypto_test_1009(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_ALG_CFB */
static void tfm_s_crypto_test_1010(struct test_result_t *ret);
static void tfm_s_crypto_test_1011(struct test_result_t *ret);
static void tfm_s_crypto_test_1012(struct test_result_t *ret);
#ifdef TFM_CRYPTO_TEST_ALG_SHA_512
static void tfm_s_crypto_test_1013(struct test_result_t *ret);
static void tfm_s_crypto_test_1014(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_ALG_SHA_512 */
static void tfm_s_crypto_test_1019(struct test_result_t *ret);
static void tfm_s_crypto_test_1020(struct test_result_t *ret);
#ifdef TFM_CRYPTO_TEST_ALG_SHA_512
static void tfm_s_crypto_test_1021(struct test_result_t *ret);
static void tfm_s_crypto_test_1022(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_ALG_SHA_512 */
static void tfm_s_crypto_test_1024(struct test_result_t *ret);
#ifdef TFM_CRYPTO_TEST_ALG_CCM
static void tfm_s_crypto_test_1030(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_ALG_CCM */
#ifdef TFM_CRYPTO_TEST_ALG_GCM
static void tfm_s_crypto_test_1031(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_ALG_GCM */
static void tfm_s_crypto_test_1032(struct test_result_t *ret);
static void tfm_s_crypto_test_1033(struct test_result_t *ret);
static void tfm_s_crypto_test_1034(struct test_result_t *ret);
static void tfm_s_crypto_test_1035(struct test_result_t *ret);
#ifdef TFM_CRYPTO_TEST_ALG_CCM
static void tfm_s_crypto_test_1036(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_ALG_CCM */
static void tfm_s_crypto_test_1037(struct test_result_t *ret);
static void tfm_s_crypto_test_1038(struct test_result_t *ret);
#ifdef TFM_CRYPTO_TEST_HKDF
static void tfm_s_crypto_test_1039(struct test_result_t *ret);
#endif /* TFM_CRYPTO_TEST_HKDF */

static struct test_t crypto_tests[] = {
    {&tfm_s_crypto_test_1001, "TFM_S_CRYPTO_TEST_1001",
     "Secure Key management interface", {TEST_PASSED} },
#ifdef TFM_CRYPTO_TEST_ALG_CBC
    {&tfm_s_crypto_test_1002, "TFM_S_CRYPTO_TEST_1002",
     "Secure Symmetric encryption (AES-128-CBC) interface", {TEST_PASSED} },
#endif /* TFM_CRYPTO_TEST_ALG_CBC */
#ifdef TFM_CRYPTO_TEST_ALG_CFB
    {&tfm_s_crypto_test_1003, "TFM_S_CRYPTO_TEST_1003",
     "Secure Symmetric encryption (AES-128-CFB) interface", {TEST_PASSED} },
#endif /* TFM_CRYPTO_TEST_ALG_CFB */
#ifdef TFM_CRYPTO_TEST_ALG_CTR
    {&tfm_s_crypto_test_1005, "TFM_S_CRYPTO_TEST_1005",
     "Secure Symmetric encryption (AES-128-CTR) interface", {TEST_PASSED} },
#endif /* TFM_CRYPTO_TEST_ALG_CTR */
    {&tfm_s_crypto_test_1007, "TFM_S_CRYPTO_TEST_1007",
     "Secure Symmetric encryption invalid cipher", {TEST_PASSED} },
    {&tfm_s_crypto_test_1008, "TFM_S_CRYPTO_TEST_1008",
     "Secure Symmetric encryption invalid cipher (AES-152)", {TEST_PASSED} },
#ifdef TFM_CRYPTO_TEST_ALG_CFB
    {&tfm_s_crypto_test_1009, "TFM_S_CRYPTO_TEST_1009",
     "Secure Symmetric encryption invalid cipher (HMAC-128-CFB)", {TEST_PASSED} },
#endif /* TFM_CRYPTO_TEST_ALG_CFB */
    {&tfm_s_crypto_test_1010, "TFM_S_CRYPTO_TEST_1010",
     "Secure Unsupported Hash (SHA-1) interface", {TEST_PASSED} },
    {&tfm_s_crypto_test_1011, "TFM_S_CRYPTO_TEST_1011",
     "Secure Hash (SHA-224) interface", {TEST_PASSED} },
    {&tfm_s_crypto_test_1012, "TFM_S_CRYPTO_TEST_1012",
     "Secure Hash (SHA-256) interface", {TEST_PASSED} },
#ifdef TFM_CRYPTO_TEST_ALG_SHA_512
    {&tfm_s_crypto_test_1013, "TFM_S_CRYPTO_TEST_1013",
     "Secure Hash (SHA-384) interface", {TEST_PASSED} },
    {&tfm_s_crypto_test_1014, "TFM_S_CRYPTO_TEST_1014",
     "Secure Hash (SHA-512) interface", {TEST_PASSED} },
#endif /* TFM_CRYPTO_TEST_ALG_SHA_512 */
    {&tfm_s_crypto_test_1019, "TFM_S_CRYPTO_TEST_1019",
     "Secure Unsupported HMAC (SHA-1) interface", {TEST_PASSED} },
    {&tfm_s_crypto_test_1020, "TFM_S_CRYPTO_TEST_1020",
     "Secure HMAC (SHA-256) interface", {TEST_PASSED} },
#ifdef TFM_CRYPTO_TEST_ALG_SHA_512
    {&tfm_s_crypto_test_1021, "TFM_S_CRYPTO_TEST_1021",
     "Secure HMAC (SHA-384) interface", {TEST_PASSED} },
    {&tfm_s_crypto_test_1022, "TFM_S_CRYPTO_TEST_1022",
     "Secure HMAC (SHA-512) interface", {TEST_PASSED} },
#endif /* TFM_CRYPTO_TEST_ALG_SHA_512 */
    {&tfm_s_crypto_test_1024, "TFM_S_CRYPTO_TEST_1024",
     "Secure HMAC with long key (SHA-224) interface", {TEST_PASSED} },
#ifdef TFM_CRYPTO_TEST_ALG_CCM
    {&tfm_s_crypto_test_1030, "TFM_S_CRYPTO_TEST_1030",
     "Secure AEAD (AES-128-CCM) interface", {TEST_PASSED} },
#endif /* TFM_CRYPTO_TEST_ALG_CCM */
#ifdef TFM_CRYPTO_TEST_ALG_GCM
    {&tfm_s_crypto_test_1031, "TFM_S_CRYPTO_TEST_1031",
     "Secure AEAD (AES-128-GCM) interface", {TEST_PASSED} },
#endif /* TFM_CRYPTO_TEST_ALG_GCM */
    {&tfm_s_crypto_test_1032, "TFM_S_CRYPTO_TEST_1032",
     "Secure key policy interface", {TEST_PASSED} },
    {&tfm_s_crypto_test_1033, "TFM_S_CRYPTO_TEST_1033",
     "Secure key policy check permissions", {TEST_PASSED} },
    {&tfm_s_crypto_test_1034, "TFM_S_CRYPTO_TEST_1034",
     "Secure persistent key interface", {TEST_PASSED} },
    {&tfm_s_crypto_test_1035, "TFM_S_CRYPTO_TEST_1035",
     "Key access control", {TEST_PASSED} },
#ifdef TFM_CRYPTO_TEST_ALG_CCM
    {&tfm_s_crypto_test_1036, "TFM_S_CRYPTO_TEST_1036",
     "Secure AEAD interface with truncated auth tag (AES-128-CCM-8)",
     {TEST_PASSED} },
#endif /* TFM_CRYPTO_TEST_ALG_CCM */
    {&tfm_s_crypto_test_1037, "TFM_S_CRYPTO_TEST_1037",
     "Secure TLS 1.2 PRF key derivation", {TEST_PASSED} },
    {&tfm_s_crypto_test_1038, "TFM_S_CRYPTO_TEST_1038",
     "Secure TLS-1.2 PSK-to-MasterSecret key derivation", {TEST_PASSED} },
#ifdef TFM_CRYPTO_TEST_HKDF
    {&tfm_s_crypto_test_1039, "TFM_S_CRYPTO_TEST_1039",
