...
/* List of tests */
static void tfm_s_ps_test_2001(struct test_result_t *ret);
static void tfm_s_ps_test_2002(struct test_result_t *ret);

static struct test_t reliability_tests[] = {
    {&tfm_s_ps_test_2001, "TFM_S_PS_TEST_2001",
     "repetitive sets and gets in/from an asset", {TEST_PASSED} },
    {&tfm_s_ps_test_2002, "TFM_S_PS_TEST_2002",
