...
/* List of tests */
static void tfm_s_ps_test_3001(struct test_result_t *ret);
static void tfm_s_ps_test_3002(struct test_result_t *ret);
static void tfm_s_ps_test_3003(struct test_result_t *ret);
static void tfm_s_ps_test_3004(struct test_result_t *ret);
static void tfm_s_ps_test_3005(struct test_result_t *ret);
static void tfm_s_ps_test_3006(struct test_result_t *ret);
static void tfm_s_ps_test_3007(struct test_result_t *ret);
static void tfm_s_ps_test_3008(struct test_result_t *ret);
static void tfm_s_ps_test_3009(struct test_result_t *ret);

static struct test_t interface_tests[] = {
    {&tfm_s_ps_test_3001, "TFM_S_PS_TEST_3001",
     "Check PS area version when NV counters 1/2/3 have the same value", {TEST_PASSED}},
    {&tfm_s_ps_test_3002, "TFM_S_PS_TEST_3002",
     "Check PS area version when it is different from NV counters 1/2/3", {TEST_PASSED}},
    {&tfm_s_ps_test_3003, "TFM_S_PS_TEST_3003",
    ...
    {&tfm_s_ps_test_3004, "TFM_S_PS_TEST_3004",
    ...
    {&tfm_s_ps_test_3005, "TFM_S_PS_TEST_3005",
     "Check PS area version when NV counters 2 and 3 are equals, 1 is "
     "different and PS area version match NV counter 1", {TEST_PASSED}},
    {&tfm_s_ps_test_3006, "TFM_S_PS_TEST_3006",
