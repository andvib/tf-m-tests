...
/* List of tests */
static void tfm_attest_test_4001(struct test_result_t *ret);
#ifdef INCLUDE_TEST_CODE /* Remove them from release build */
static void tfm_attest_test_4002(struct test_result_t *ret);
static void tfm_attest_test_4003(struct test_result_t *ret);
static void tfm_attest_test_4004(struct test_result_t *ret);
static void tfm_attest_test_4005(struct test_result_t *ret);
#endif

static struct test_t attestation_interface_tests[] = {
    {&tfm_attest_test_4001, "TFM_ATTEST_TEST_4001",
     "Symmetric key algorithm based Initial Attestation test", {0} },
#ifdef INCLUDE_TEST_CODE /* Remove them from release build */
    {&tfm_attest_test_4002, "TFM_ATTEST_TEST_4002",
     "Minimal token test of attest token", {0} },
    {&tfm_attest_test_4003, "TFM_ATTEST_TEST_4003",
     "Minimal token size test of attest token", {0} },
    {&tfm_attest_test_4004, "TFM_ATTEST_TEST_4004",
     "Short circuit tag test of attest token", {0} },
    {&tfm_attest_test_4005, "TFM_ATTEST_TEST_4005",
...
register_testsuite_s_attestation_interface(struct test_suite_t *p_test_suite)
{
    ...
    set_testsuite("Symmetric key algorithm based Initial Attestation Service "
                  "secure interface tests (TFM_ATTEST_TEST_4XXX)",
...
static void tfm_attest_test_4001(struct test_result_t *ret)
{
    ...
    if (err != 0) {
        TEST_LOG("tfm_attest_test_4001() returned: %d\r\n", err);
        TEST_FAIL("Attest token tfm_attest_test_4001() has failed");
        return;
    }
