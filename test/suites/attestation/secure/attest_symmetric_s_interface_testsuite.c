...
/* List of tests */
static void tfm_s_attest_test_2001(struct test_result_t *ret);
#ifdef INCLUDE_TEST_CODE /* Remove them from release build */
static void tfm_s_attest_test_2002(struct test_result_t *ret);
static void tfm_s_attest_test_2003(struct test_result_t *ret);
static void tfm_s_attest_test_2004(struct test_result_t *ret);
static void tfm_s_attest_test_2005(struct test_result_t *ret);
#endif

static struct test_t attestation_interface_tests[] = {
    {&tfm_s_attest_test_2001, "TFM_S_ATTEST_TEST_2001",
     "Symmetric key algorithm based Initial Attestation test", {0} },
#ifdef INCLUDE_TEST_CODE /* Remove them from release build */
    {&tfm_s_attest_test_2002, "TFM_S_ATTEST_TEST_2002",
     "Minimal token test of attest token", {0} },
    {&tfm_s_attest_test_2003, "TFM_S_ATTEST_TEST_2003",
     "Minimal token size test of attest token", {0} },
    {&tfm_s_attest_test_2004, "TFM_S_ATTEST_TEST_2004",
     "Short circuit tag test of attest token", {0} },
    {&tfm_s_attest_test_2005, "TFM_S_ATTEST_TEST_2005",
...
static void tfm_s_attest_test_2001(struct test_result_t *ret)
{
    ...
    if (err != 0) {
        TEST_LOG("tfm_s_attest_test_2001() returned: %d\r\n", err);
        TEST_FAIL("Attest token tfm_s_attest_test_2001() has failed");
        return;
    }
