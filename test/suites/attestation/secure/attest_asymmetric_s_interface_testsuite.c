...
static void tfm_attest_test_3001(struct test_result_t *ret);
static void tfm_attest_test_3002(struct test_result_t *ret);
static void tfm_attest_test_3003(struct test_result_t *ret);
#endif
static void tfm_attest_test_3004(struct test_result_t *ret);
static void tfm_attest_test_3005(struct test_result_t *ret);

static struct test_t attestation_interface_tests[] = {
#ifdef INCLUDE_TEST_CODE /* Remove them from release build */
    {&tfm_attest_test_3001, "TFM_ATTEST_TEST_3001",
     "Minimal token test of attest token", {TEST_PASSED} },
    {&tfm_attest_test_3002, "TFM_ATTEST_TEST_3002",
     "Minimal token size test of attest token", {TEST_PASSED} },
    {&tfm_attest_test_3003, "TFM_ATTEST_TEST_3003",
     "Short circuit signature test of attest token", {TEST_PASSED} },
#endif
    {&tfm_attest_test_3004, "TFM_ATTEST_TEST_3004",
     "ECDSA signature test of attest token", {TEST_PASSED} },
    {&tfm_attest_test_3005, "TFM_ATTEST_TEST_3005",
