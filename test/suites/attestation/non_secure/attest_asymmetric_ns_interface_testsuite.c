...
static void tfm_ns_attest_test_1001(struct test_result_t *ret);
static void tfm_ns_attest_test_1002(struct test_result_t *ret);
static void tfm_ns_attest_test_1003(struct test_result_t *ret);
#endif
static void tfm_ns_attest_test_1004(struct test_result_t *ret);
static void tfm_ns_attest_test_1005(struct test_result_t *ret);

static struct test_t attestation_interface_tests[] = {
#ifdef INCLUDE_TEST_CODE /* Remove them from release build */
    {&tfm_ns_attest_test_1001, "TFM_NS_ATTEST_TEST_1001",
     "Minimal token test of attest token", {TEST_PASSED} },
    {&tfm_ns_attest_test_1002, "TFM_NS_ATTEST_TEST_1002",
     "Minimal token size test of attest token", {TEST_PASSED} },
    {&tfm_ns_attest_test_1003, "TFM_NS_ATTEST_TEST_1003",
     "Short circuit signature test of attest token", {TEST_PASSED} },
#endif
    {&tfm_ns_attest_test_1004, "TFM_NS_ATTEST_TEST_1004",
     "ECDSA signature test of attest token", {TEST_PASSED} },
    {&tfm_ns_attest_test_1005, "TFM_NS_ATTEST_TEST_1005",
